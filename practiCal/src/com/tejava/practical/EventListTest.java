...
public class EventListTest {
	...
	@Test
	public void testInsertIntIntIntIntIntIntIntStringStringIntIntIntString() throws Exception{
	...
	public void testEdit() throws Exception{
		...
		for(testday=1;testday<31;testday++){
			for(testHour=1;testHour<21;testHour++){
				for(testEventGroup=1;testEventGroup<3;testEventGroup++){
					SingleEvent SingleEvent1 = new SingleEvent(testid,14, 12, testday, testHour, testHour, 10, 30,"test"+testid , "Description", testEventGroup, 1, 1, "test");
					SingleEvent SingleEvent2 = new SingleEvent(testid,14, 12, testday, testHour, testHour, 40, 50,"test"+testid , "Description", testEventGroup, 1, 1, "test");
					
					EventList1.Insert(SingleEvent1);
					EventList2.Insert(SingleEvent2);
			...
			assertNotEquals(EventList2, EventList1);
		}
		testid = 0;
		for(testday=1;testday<31;testday++){
			for(testHour=1;testHour<21;testHour++){
				for(testEventGroup=1;testEventGroup<3;testEventGroup++){
					SingleEvent SingleEvent2 = new SingleEvent(testid,14, 12, testday, testHour, testHour, 40, 50,"test"+testid , "Description", testEventGroup, 1, 1, "test");
					EventList1.context.Edit(SingleEvent2);
			...
			assertEquals(EventList2, EventList1);
		}
		
		assertEquals(1200, testid);
		assertEquals(1200, EventList1.GetSize());
